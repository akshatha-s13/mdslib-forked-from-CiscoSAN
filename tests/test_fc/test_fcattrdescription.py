...
class TestFcAttrDescription(unittest.TestCase):
    ...
    def test_description_write_beyondmax(self):
        ...
        with self.assertRaises(CLIError) as e:
            fc.description = desc
        self.assertEqual("The command \" interface "+str(self.fc_name[2])+" ; switchport description  "+str(desc)+" \" gave the error \" % String exceeded max length of (254) \".",str(e.exception))
