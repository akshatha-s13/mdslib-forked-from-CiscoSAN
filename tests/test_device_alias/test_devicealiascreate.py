...
class TestDeviceAliasCreate(unittest.TestCase):
    ...
    def test_create_name_invalid(self):
        ...
        self.assertEqual("The command \" device-alias database ;  device-alias name "+str(name)+" pwwn "+str(pwwn)+" ; \" gave the error \" Illegal character present in the name \".",str(e.exception))
        d.clear_lock()
    ...
    def test_create_name_invalidfirstchar(self):
        ...
        self.assertEqual("The command \" device-alias database ;  device-alias name "+str(name)+" pwwn "+str(pwwn)+" ; \" gave the error \" Illegal first character. Name must start with a letter \".",str(e.exception))
        d.clear_lock()
    ...
    def test_create_name_beyondmax(self):
        ...
        self.maxDiff = 1000
        self.assertEqual("The command \" device-alias database ;  device-alias name "+str(name)+" pwwn "+str(pwwn)+" ; \" gave the error \" % String exceeded max length of (64) \".",str(e.exception))
